...
<div id="wholeContainer" class="WholeContainer">
    <div class="Sec1Container">
        ...
        <div class="writeUps">
            ...
            <br>
            <h6>Make networking fun, convenient, and rewarding with
                <br>
                <span style="font-weight: bold;">just a Tap!</span>
            </h6>
            ...
            <button onclick="document.location='waitlistRegister.php' " class="signup">Get your free card</button>
    ...
    <div class="Sec4Container">
        <div class="sec4Writeup">
            <p>Effortless Networking </p>
            <h6>Track your connections, create tasks, integrate with your
                favorite tools, and <span style="font-weight: bold;">never forget to catch up with someone.</span></h6>
            <button onclick="document.location='waitlistRegister.php' " class="signup">Get your free card</button>
        </div>
        <div class="sec4image">
    ...
    <!-- Sec6 Start -->
    <!-- <div class="Sec6Container">
        <div class="sec6UpperGridWriteup">
            <h1 style="margin-bottom: 0px;">Get a free Tap card or just</h1>
            <h1 style="margin-top: 0px;">Pre-order one!</h1>
        </div>
        <div class="sec6MidGrid">
            <div class="sec6MidGrid-Content">
                <div class="sec6MidGrid-Circle">
                    <h1>1</h1>
                </div>
            ...
            <div class="sec6MidGrid-Content">
                ...
                <h2>Share with 3 friends</h2>
                <h3>Add contents and pages to your site.</h3>
            ...
            <div class="sec6MidGrid-Content">
                ...
                <h2>Look in your mailbox!</h2>
                <h3>Now publish to make your site live!</h3>

            </div>

        </div>
        <div class="sec6BottomGrid">
            <button onclick="document.location='waitlistRegister.php' " class="signup">Get your free card</button>
            <button class="signup">Pre-order</button>
        </div>
    </div> -->
    <!-- Sec6 End -->
    <?php
